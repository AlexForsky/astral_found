...
if (mail($address, $sub, $mes, $from)) {
 header('Refresh: 5; URL=http://astral.gk-soft.ru/1cproduct.html');
 echo '<head>
    <meta http-equiv="refresh" content="5; URL=http://astral.gk-soft.ru/1cproduct.html"/><meta charset="utf-8"/></head>
