...
if (mail($address, $sub, $mes, $from)) {
 header('Refresh: 5; URL=http://astral.gk-soft.ru/tarif_1crep.html');
 echo '<head>
    <meta http-equiv="refresh" content="5; URL=http://astral.gk-soft.ru/tarif_1crep.html"/><meta charset="utf-8"/></head>
