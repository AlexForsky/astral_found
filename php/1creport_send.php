...
if (mail($address, $sub, $mes, $from)) {
 header('Refresh: 5; URL=http://astral.gk-soft.ru/1creport.html');
 echo '<head>
    <meta http-equiv="refresh" content="5; URL=http://astral.gk-soft.ru/1creport.html"/><meta charset="utf-8"/></head>
